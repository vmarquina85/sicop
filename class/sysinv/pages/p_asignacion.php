  ...
  <div id="header" class="header navbar navbar-inverse bg-navbar navbar-fixed-top">
   ...
   <div class="container-fluid">
    ...
    <a href="p_main.php" class="navbar-brand" style='width: auto;'>
      ...
      <strong class='text-white sombrear'>Asignar Bienes</strong>
    </a>
  </div>
...
<div class='well'>
  ...
  <div class="col-md-4">
    <div class="form-group">
      ...
      <select id="sl_tipobien" class='form-control input-sm m-r-10 m-b-5' onChange='obtenerCodigo();'>
  ...
  <div class="col-md-4">             
    ...
    <div class='row'>
      <div class="col-md-9"> 
        <input type="text" id="txt_cod_1" class="form-control input-sm  m-b-5"  disabled > </div>
  
        <div class="col-md-3"> 
         <input type="text" id="txt_cod_2" class="form-control input-sm  m-b-5"   > </div>
       </div>
     </div>
