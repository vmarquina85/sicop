...
class dInterno extends conectar
{
	private $t;
	...
	function Get_dInterno($limit, $offset,$nro,$origen,$destino,$estado){
		...
		session_start();
		if ($_SESSION["usr_niv"] <> 'A') $cad.= " and (mov_transpo='" . $_SESSION['usr_idper'] . "' or mov_personal='" .  $_SESSION['usr_idper'] . "') ";
