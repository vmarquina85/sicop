...
class PDF extends FPDF {
    ...
    function Header() {
        ...
        $this->Cell(7, 4, 'ITEM', 'LT', 0, '');
        $this->Cell(20, 4, 'CODIGO', 'T', 0, '');
        $this->Cell(13, 4, 'CODIGO', 'T', 0, '');
        $this->Cell(80, 4, 'TIPO DE BIEN', 'T', 0, '');
        $this->Cell(20, 4, 'FECHA', 'T', 0, '');
        $this->Cell(16, 4, 'ESTADO', 'T', 0, '');
        $this->Cell(16, 4, 'VALOR', 'T', 0, 'R');
        $this->Cell(60, 4, 'LOCAL', 'T', 0, '');
        $this->Cell(20, 4, 'AREA', 'T', 0, '');
        $this->Cell(25, 4, 'OFICINA', 'T', 0, '');
        $this->Cell(10, 4, 'USU', 'TR', 1, '');
        $this->Cell(7, 4, '', 'LB', 0, '');
        $this->Cell(20, 4, 'PATRIMONIAL', 'B', 0, '');
        $this->Cell(13, 4, 'INTERNO', 'B', 0, '');
        $this->Cell(80, 4, '', 'B', 0, '');
        $this->Cell(20, 4, 'DE ADQ', 'B', 0, '');
        $this->Cell(16, 4, '', 'B', 0, '');
        $this->Cell(16, 4, 'EN LIBROS', 'B', 0, 'R');
        $this->Cell(60, 4, '', 'B', 0, '');
        $this->Cell(20, 4, '', 'B', 0, '');
        $this->Cell(25, 4, '', 'B', 0, '');
        $this->Cell(10, 4, '', 'BR', 1, '');
