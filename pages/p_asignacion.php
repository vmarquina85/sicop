    ...
    <div id="content" class="content">
      <div class="panel panel-success">
        <div class="panel-heading">
          ...
          <h4 class="panel-title">Registro de Asignaciones</h4>
        </div>
        <div class="panel-body">
          ...
          <form action ='javascript:;' class='form-inline' method='POST' id='panelForm'>
            ...
            <select  id="sl_origen" class='form-control input-sm m-r-10  m-b-5'>
              ...
              <form id='formulario'>
                ...
                <div class="row">
                  ...
                  <div class="col-md-3">
                    ...
                    <select onchange='obtener_personal();' id="sl_asignacionDestino" class='form-control input-sm m-r-10  m-b-5'>
                      <option value="*">--Seleccionar Destino--</option>
                      <?php for ($i = 0; $i < sizeof($rs_destino); $i++) { ?>
                        <option value="<?php echo utf8_encode($rs_destino[$i]['id_dep']); ?>"><?php echo utf8_encode($rs_destino[$i]['descripcion']); ?></option>
                      <?php } ?>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-5">
                      ...
                      <div class='input-group input-group-sm  m-b-5'>
                        <input type="text" id="txt_asignacionObservacion" class="form-control input-sm width-200  m-b-5">
                        <a href='javascript:agregar_detalle();'  title='Agregar Bien' class='btn btn-sm btn-success  m-l-5'><i class='fa fa-plus'></i></a>
                        <a href='javascript:agregar_detalle();' title='Agregar Todos' class='btn btn-sm btn-success m-l-5'>Todos</a>
