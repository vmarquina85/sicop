...
var handleSlimScroll = function() {
    ...
    handleSidebarMenu = function() {
        ...
        $(".sidebar .nav > .has-sub > a").click(function() {
            ...
            0 === $(".page-sidebar-minified").length && ($(a).not(e).slideUp(0, function() {
                $(this).closest("li").removeClass("expand")
            }), $(e).slideToggle(0, function() {
                var a = $(this).closest("li");
                $(a).hasClass("expand") || !$(e).is(":visible") ? $(a).removeClass("expand") : $(a).addClass("expand")
            }))
    ...
    handleToggleNavbarSearch = function() {
        $('[data-toggle="navbar-search"]').click(function(e) {
            e.preventDefault(), $(".navbar").addClass("navbar-search-toggled")
        })
    },
    handleDismissNavbarSearch = function() {
        $('[data-dismiss="navbar-search"]').click(function(e) {
            e.preventDefault(), $(".navbar").removeClass("navbar-search-toggled")
        })
    },
    handleToggleNavProfile = function() {
        $('[data-toggle="nav-profile"]').click(function(e) {
            ...
            var a = $(this).closest("li"),
                ...
                i = "active";
            $(a).hasClass(i) ? ($(a).removeClass(i), $(t).removeClass(i)) : ($(a).addClass(i), $(t).addClass(i))
        })
    },
    App = function() {
        "use strict";
